...
public class PopoverView extends RelativeLayout implements OnTouchListener {
    ...
    public final static int PopoverArrowDirectionV = PopoverArrowDirectionUp | PopoverArrowDirectionDown;
     ...
     */
    public static int defaultPopoverArrowUpDrawable = R.mipmap.icon_popover_arrow_up;
    /**
     * The default popover arrow down drawable for all the popovers
     */
    public static int defaultPopoverArrowDownDrawable = R.mipmap.icon_popover_arrow_down;
    /**
     * The default popover arrow left drawable for all the popovers
     */
    public static int defaultPopoverArrowLeftDrawable = R.mipmap.icon_popover_arrow_left;
    /**
     * The default popover arrow down drawable for all the popovers
     */
    public static int defaultPopoverArrowRightDrawable = R.mipmap.icon_popover_arrow_right;
    ...
    private void setNightStyle(boolean nightStyle) {
        this.nightStyle = nightStyle;
        if (nightStyle) {
            defaultPopoverBackgroundDrawable = R.drawable.background_popover_night;
            defaultPopoverArrowUpDrawable = R.mipmap.icon_popover_arrow_up_night;
            defaultPopoverArrowDownDrawable = R.mipmap.icon_popover_arrow_down_night;
        } else {
            defaultPopoverBackgroundDrawable = R.drawable.background_popover;
            defaultPopoverArrowUpDrawable = R.mipmap.icon_popover_arrow_up;
            defaultPopoverArrowDownDrawable = R.mipmap.icon_popover_arrow_down;
        }
    }
    ...
    public PopoverView(Context context, int layoutId, boolean nightStyle) {
        super(context);
        setNightStyle(nightStyle);
        initPopoverView(inflate(context, layoutId, null));
    }
    ...
    private void initPopoverView(View viewToEnclose) {
        ...
        contentTextView = (TextView) viewToEnclose.findViewById(R.id.popover_showed_view);
        if (nightStyle) {
            contentTextView.setTextColor(getContext().getResources().getColorStateList(R.color.epub_book_alertcontentcolor_nightstyle));
        } else {
            contentTextView.setTextColor(getContext().getResources().getColorStateList(R.color.epub_book_alertcontentcolor_whitestyle));
        }
    ...
    public void setContentText(String htmlString) {
    ...
    private void addPopoverInRect(Rect insertRect) {
        ...
        insertParams.leftMargin = 10;//insertRect.left;
        insertParams.topMargin = insertRect.top;
        insertParams.rightMargin = 10;
        insertParams.bottomMargin = 10;
        //Add the view
